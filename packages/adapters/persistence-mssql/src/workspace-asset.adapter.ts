...
/**
 * MSSQL adapter for WorkspaceAssetPort.
 *
 * Not yet implemented — tracked in GitHub issue.
 * All methods return AssetStorageError with a clear message.
 * Wire the Postgres adapter for MSSQL installations until this is complete.
 */
export class MssqlWorkspaceAssetAdapter implements WorkspaceAssetPort {
  private _notImplemented(): AssetStorageError {
    return new AssetStorageError(
      'MssqlWorkspaceAssetAdapter is not yet implemented. ' + 'See GitHub issue for tracking.',
    );
  }

...
// Stub — full implementation deferred. See GitHub issue: vllm-adapter
// vLLM is self-hosted; exposes OpenAI-compatible API. PII rules exempt.
...
const NOT_IMPLEMENTED = new AiError('PROVIDER_ERROR', 'vLLM adapter not yet implemented');

export class VllmAdapter implements AIProviderPort {
  readonly id = 'vllm';

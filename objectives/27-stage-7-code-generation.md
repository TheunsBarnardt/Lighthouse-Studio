...
- **ADR-0245: Generation-Time SCA Gate** — when generated `package.json` / lockfile changes, `VulnerabilityScannerPort` runs before the change is presented for review; `high`+ findings require explicit acknowledgment
...
- [ ] ADR-0245 (generation-time SCA gate) written and Accepted
- [ ] ADR-0249 (per-app `docs/adr/` folder seeded from PRD) written and Accepted
...
- [ ] **D9 — Plan-rigor scaffolding (per ADR-0249).** Every generated app repo ships with:

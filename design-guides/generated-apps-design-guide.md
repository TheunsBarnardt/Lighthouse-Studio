...
_The design language for applications the platform generates for customers. NOT the design language for the platform's own admin interface — that's the Platform UI Design Guide. This document covers what Stage 6 (UI Generation, Objective 26) produces._
...
_This guide is the contract for what Stage 6's generation produces. Implementation lives in `packages/core/src/ai/prompts/ui-generation/`. When this guide and Objective 26 conflict, this guide wins for visual decisions; the objective wins for functional decisions._

_Status: v1, written before Stage 6 ships. Will iterate as the first generated apps reveal what's missing or wrong._

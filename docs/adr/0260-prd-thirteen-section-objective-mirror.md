...
8. ADRs to Write — titled stubs with rationale (seeds the per-app `docs/adr/` per ADR-0261)
...
- **ADR scaffolding (ADR-0261) becomes natural.** Section 8 is the seed; the per-app `docs/adr/` folder is its destination.
...
### Option A: Keep the 10-section PRD; add ADR-0261-style scaffolding only

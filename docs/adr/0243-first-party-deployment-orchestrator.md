# ADR-0243: First-Party Deployment Orchestrator
...
| CVE gate     | `VulnerabilityScannerPort` (ADR-0242) invoked before promotion in both modes                                                       |
...
- ADR-0242 (CVE scan gate — runs inside the orchestrator)

  ...
  tests: [
    {
      ...
      assertions: [
        ...
        { type: 'contains_goal_with_priority', priority: 'must' },
      ],
    },
  ],
});
...
*This document is the contract. Every checkbox in Section 10 must be true before any AI pipeline stage begins.*

...
export class SchemaSynthesisService {
  ...
  async synthesizeSchema(
    ctx: RequestContext,
    input: SynthesizeSchemaInput,
  ): Promise<Result<Artifact<SynthesizedSchema>, AppError>>;
...
*This document is the contract. Every checkbox in Section 10 must be true before moving on to Objective 25.*

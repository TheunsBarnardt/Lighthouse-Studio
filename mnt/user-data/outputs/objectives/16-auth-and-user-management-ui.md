...
export class EmailTemplateService {
  async render(
    ...
    workspaceId?: string,
  ): Promise<Result<{ html: string; text: string; subject: string }, AppError>>;
...
*This document is the contract. Every checkbox in Section 10 must be true before moving on to Objective 17.*

...
export class DataMigrationService {
  ...
  ): Promise<Result<Artifact<MigrationPlan>, AppError>>;
  ...
  async rollbackMigration(
    ctx: RequestContext,
    executionId: string,
  ): Promise<Result<RollbackResult, AppError>>;
}
```
...
*This document is the contract. Every checkbox in Section 10 must be true before moving on to Objective 26.*

...
A new subscriber typically wants to know the *current state* of the watched table, then receive *changes from now on*. Three approaches:
...
export type ChangeEvent =
  | { kind: 'data'; table: string; schema?: string; operation: ChangeOperation;

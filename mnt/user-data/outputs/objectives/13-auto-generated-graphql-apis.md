...
export const resolvers = {
  ...
  createResolver: async (parent, args, context) => { /* validate, authorize, execute, audit */ },
...
export async function makeConnection<T extends { id: string }>(
...
*This document is the contract. Every checkbox in Section 10 must be true before moving on to Objective 14.*

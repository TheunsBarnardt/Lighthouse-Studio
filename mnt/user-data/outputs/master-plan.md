...
*Updated to reflect Objectives 1–30. The 30 objective documents in `/objectives/` are the implementation contract; this document is the thesis and the roadmap.*
...
*Master plan v3 — supersedes v1 (deleted 2026-05-01) and v2. Update when a Phase completes; rewrite if the thesis shifts.*

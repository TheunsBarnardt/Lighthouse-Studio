          ...
          <form onSubmit={(e) => { e.preventDefault(); void form.handleSubmit(onSubmit)(e); }} className="space-y-4" noValidate>
            <FormField control={form.control} name="current" render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input type="password" autoComplete="current-password" aria-required {...field} /></FormControl>
                <FormMessage />
              </FormItem>
            )} />
            <FormField control={form.control} name="password" render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input type="password" autoComplete="new-password" aria-required {...field} /></FormControl>
                <FormMessage />
              </FormItem>
            )} />

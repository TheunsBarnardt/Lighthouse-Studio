  ...
  return (
    <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 16 }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <h2 style={{ fontWeight: 600, fontSize: 14 }}>Signals ({signals.length})</h2>
        <Button
          size="sm"
          type="button"
      ...
      {signals.length === 0 ? (
        ...
        >
          <Bug style={{ width: 32, height: 32 }} />
          <p style={{ fontSize: 13, margin: 0 }}>
            No signals detected. Connect error tracking and monitoring to surface issues here.
          </p>
        </div>
      ) : null}
